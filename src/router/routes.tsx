...
const Admin = lazy(() => import('../pages/Apps/admin'));
const Concerts = lazy(() => import('../pages/Apps/concerts'));
const Tickets = lazy(() => import('../pages/Apps/tickets'));



const NativeUsers = lazy(() => import('../pages/native/Users'));
const TopUp = lazy(() => import('../pages/native/TopUp'));
const Debit = lazy(() => import('../pages/native/Debit'));
const Transactions = lazy(() => import('../pages/native/Transaction'));
