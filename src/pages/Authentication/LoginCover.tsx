...
import logo from '../../images/native.png';
...
const LoginCover = () => {
    ...
    useEffect(() => {
        dispatch(setPageTitle('NATIVE LODGE MANAGEMENT SYSTEM'));
    });
        ...
        >
            <div className="w-full max-w-md bg-white shadow-lg rounded-lg p-6">
                ...
                <div className="flex justify-center mb-6">
                    <img src={logo} alt="Logo" className="w-28 sm:w-28" />
                </div>


                {/* Header */}
                <h2 className="text-lg font-bold text-gray-800 text-center mb-2">USER MANAGEMENT SYSTEM</h2>
